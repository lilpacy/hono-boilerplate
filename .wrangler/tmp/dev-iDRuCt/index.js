...
var require_PostgrestError = __commonJS({
  "node_modules/@supabase/postgrest-js/dist/cjs/PostgrestError.js"(exports) {
    ...
    __name(PostgrestError, "PostgrestError");
...
// .wrangler/tmp/bundle-qNXCow/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-qNXCow/middleware-insertion-facade.js
init_modules_watch_stub();
...
// src/db/supabaseClient.ts
var getSupabaseClient = /* @__PURE__ */ __name((context) => {
...
// src/controllers/AuthController.ts
var getUsers = /* @__PURE__ */ __name(async () => {
  const data = { data: [{ id: "1", email: "goktugcy@gmail.com" }] };
  return data;
}, "getUsers");
var getTest = /* @__PURE__ */ __name(async (ctx) => {
  const { data, error } = await getSupabaseClient(ctx).supabaseAnon.from("announcements").select("*");
  if (error) {
    return error;
  }
  return data;
